        ...
        <div className="mb-4">
          ...
          <div className="flex justify-center mb-4">
            ...
            >
              ...
              <span className="text-white font-bold w-full sm:w-auto block mt-1">Your submitted Abstracts are under review🔎 - Results will be announced soon! - Respective Team Leaders will be notified via email.</span>
