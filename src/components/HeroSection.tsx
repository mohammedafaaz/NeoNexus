          ...
          <div className="flex justify-center mb-4">
            ...
            >
              <span className="flex items-center justify-center w-full sm:w-auto mb-1 sm:mb-0">
                ...
                <span className="ml-1">Click here to Submit Abstracts - Deadline 5th August 2025 - <span className="text-[#ff1744] font-bold w-full sm:w-auto">No fee will be charged now, pay after your team is shortlisted</span></span>
              </span>
